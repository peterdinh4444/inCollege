...
01 PROFILE-RECORD.
    ...
    05 FILE-EXPERIENCE-1.
        10 FILE-EXP-TITLE-1 PIC X(50).
        10 FILE-EXP-COMPANY-1 PIC X(50).
        10 FILE-EXP-DATES-1 PIC X(30).
        10 FILE-EXP-DESCRIPTION-1 PIC X(100).
    05 FILE-EXPERIENCE-2.
        10 FILE-EXP-TITLE-2 PIC X(50).
        10 FILE-EXP-COMPANY-2 PIC X(50).
        10 FILE-EXP-DATES-2 PIC X(30).
        10 FILE-EXP-DESCRIPTION-2 PIC X(100).
    05 FILE-EXPERIENCE-3.
        10 FILE-EXP-TITLE-3 PIC X(50).
        10 FILE-EXP-COMPANY-3 PIC X(50).
        10 FILE-EXP-DATES-3 PIC X(30).
        10 FILE-EXP-DESCRIPTION-3 PIC X(100).
    05 FILE-EDUCATION-COUNT PIC 9.
    05 FILE-EDUCATION-1.
        10 FILE-EDU-DEGREE-1 PIC X(50).
        10 FILE-EDU-UNIVERSITY-1 PIC X(50).
        10 FILE-EDU-YEARS-1 PIC X(20).
    05 FILE-EDUCATION-2.
        10 FILE-EDU-DEGREE-2 PIC X(50).
        10 FILE-EDU-UNIVERSITY-2 PIC X(50).
        10 FILE-EDU-YEARS-2 PIC X(20).
    05 FILE-EDUCATION-3.
        10 FILE-EDU-DEGREE-3 PIC X(50).
        10 FILE-EDU-UNIVERSITY-3 PIC X(50).
        10 FILE-EDU-YEARS-3 PIC X(20).

FD TEMP-PROFILE-FILE.
01 TEMP-PROFILE-RECORD.
    05 TEMP-PROFILE-DATA PIC X(1435).

WORKING-STORAGE SECTION.
01 INPUT-STATUS PIC XX VALUE SPACES.
01 OUTPUT-STATUS PIC XX VALUE SPACES.
01 ACCOUNT-STATUS PIC XX VALUE SPACES.
01 PROFILE-STATUS PIC XX VALUE SPACES.
01 TEMP-PROFILE-STATUS PIC XX VALUE SPACES.
...
01 ACCOUNT-EOF-FLAG PIC X VALUE "N".
...
01 PROFILE-INDEX PIC 9 VALUE ZERO.
...
CREATE-ACCOUNT.
    ...
    IF PASSWORD-VALID NOT = "Y"
        MOVE "Password must be 8 to 12 characters and include a capital letter, a digit, and a special character."
            TO OUTPUT-LINE
        PERFORM EMIT-LINE
        EXIT PARAGRAPH
    END-IF
...
LOAD-ACCOUNTS.
    ...
    PERFORM UNTIL ACCOUNT-EOF-FLAG = "Y"
        READ ACCOUNT-FILE
            AT END
                MOVE "Y" TO ACCOUNT-EOF-FLAG
            NOT AT END
                IF ACCOUNT-COUNT < 5
                    ADD 1 TO ACCOUNT-COUNT
    ...
    PERFORM UNTIL PROFILE-MAJOR NOT = SPACES
        ...
        ELSE
            IF FUNCTION LENGTH(FUNCTION TRIM(INPUT-VALUE)) > 50
                ...
                MOVE "Major cannot exceed 50 characters." TO OUTPUT-LINE
                PERFORM EMIT-LINE
            END-IF
        END-IF
    END-PERFORM
...
GET-ABOUT-ME.
    ...
    IF FUNCTION LENGTH(FUNCTION TRIM(INPUT-VALUE)) > 200
        MOVE "About Me cannot exceed 200 characters." TO OUTPUT-LINE
        PERFORM EMIT-LINE
...
VIEW-PROFILE.
    ...
    ELSE
        PERFORM VARYING EXPERIENCE-INDEX FROM 1 BY 1
            ...
            MOVE "  Company: " TO OUTPUT-LINE
            MOVE EXP-COMPANY(EXPERIENCE-INDEX) TO OUTPUT-LINE(12:50)
            PERFORM EMIT-LINE
    ...
    ELSE
        PERFORM VARYING EDUCATION-INDEX FROM 1 BY 1
            ...
            MOVE "  University: " TO OUTPUT-LINE
            MOVE EDU-UNIVERSITY(EDUCATION-INDEX) TO OUTPUT-LINE(15:50)
            PERFORM EMIT-LINE
