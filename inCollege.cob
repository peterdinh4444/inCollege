       ...
       01  TEMP-PROFILE-RECORD             PIC X(1436).
       ...
       *> PROFILE STATE / VALIDATION
       ...
       01  FIELD-LENGTH                    PIC 9(3) VALUE ZERO.
       01  NEW-PROFILE-RECORD              PIC X(1436).
               ...
               READ ACCOUNT-FILE
                   ...
                   NOT AT END
                       IF ACCOUNT-COUNT < 5
                           ADD 1 TO ACCOUNT-COUNT
                           MOVE FILE-USERNAME
                               TO SAVED-USERNAME(ACCOUNT-COUNT)
                           MOVE FILE-PASSWORD
                               TO SAVED-PASSWORD(ACCOUNT-COUNT)
                       END-IF
               END-READ
           END-PERFORM
       ...
       READ-INPUT.
           ...
           READ INPUT-FILE
               ...
               NOT AT END
                   ...
                   MOVE INPUT-RECORD TO OUTPUT-LINE
                   PERFORM EMIT-LINE
           END-READ.
       ...
       CREATE-EDIT-PROFILE.
           ...
           GET-BASIC-PROFILE-INFORMATION.
               ...
               PERFORM UNTIL PROFILE-FIRST-NAME NOT = SPACES
                   ...
                   ELSE
                       IF FIELD-LENGTH > 30
                           MOVE "First name cannot exceed 30 characters."
                               TO OUTPUT-LINE
                           PERFORM EMIT-LINE
                       ELSE
               ...
               PERFORM UNTIL PROFILE-LAST-NAME NOT = SPACES
                   ...
                   ELSE
                       IF FIELD-LENGTH > 30
                           MOVE "Last name cannot exceed 30 characters."
                               TO OUTPUT-LINE
                           PERFORM EMIT-LINE
                       ELSE
                           MOVE FUNCTION TRIM(INPUT-VALUE)
               ...
               PERFORM UNTIL PROFILE-MAJOR NOT = SPACES
                   ...
                   ELSE
                       IF FIELD-LENGTH > 50
                           MOVE "Major cannot exceed 50 characters."
                               TO OUTPUT-LINE
                           PERFORM EMIT-LINE
                       ELSE
                           MOVE FUNCTION TRIM(INPUT-VALUE)
               ...
               PERFORM UNTIL GRAD-YEAR-VALID = "Y"
                   ...
                   IF FUNCTION LENGTH(FUNCTION TRIM(INPUT-VALUE)) NOT = 4
                       MOVE "Graduation year must be 4 digits."
                           TO OUTPUT-LINE
                       PERFORM EMIT-LINE
                   ELSE
                       MOVE FUNCTION TRIM(INPUT-VALUE) TO GRAD-YEAR-INPUT
           ...
           GET-EXPERIENCE.
               MOVE ZERO TO EXPERIENCE-COUNT
               PERFORM CLEAR-EXPERIENCE-TABLE
               ...
               PERFORM UNTIL EXPERIENCE-COUNT = 3
                   ...
                   ELSE
                       IF FIELD-LENGTH > 50
                           MOVE "Experience title cannot exceed 50 characters."
                               TO OUTPUT-LINE
                           PERFORM EMIT-LINE
                       ELSE
                           ...
                           PERFORM GET-EXPERIENCE-COMPANY
                           IF NO-MORE-INPUT
                               EXIT PARAGRAPH
                           END-IF
                           ...
                           IF NO-MORE-INPUT
                               EXIT PARAGRAPH
                           END-IF
                           PERFORM GET-EXPERIENCE-DESCRIPTION
                           IF NO-MORE-INPUT
                               EXIT PARAGRAPH
                           END-IF
                       END-IF
           ...
           GET-EXPERIENCE-DATES.
               ...
               PERFORM UNTIL EXP-DATES(EXPERIENCE-COUNT) NOT = SPACES
                   ...
                   ELSE
                       IF FIELD-LENGTH > 30
                           MOVE "Dates cannot exceed 30 characters."
                               TO OUTPUT-LINE
                           PERFORM EMIT-LINE
                       ELSE
                           MOVE FUNCTION TRIM(INPUT-VALUE)
           ...
           GET-EXPERIENCE-DESCRIPTION.
               ...
               MOVE 101 TO FIELD-LENGTH

               PERFORM UNTIL FIELD-LENGTH NOT > 100
           ...
           GET-EDUCATION.
               ...
               PERFORM UNTIL EDUCATION-COUNT = 3
                   ...
                   MOVE FUNCTION LENGTH(FUNCTION TRIM(INPUT-VALUE))
                       TO FIELD-LENGTH
                   IF FIELD-LENGTH = 0
                       MOVE "Education degree is required." TO OUTPUT-LINE
                       PERFORM EMIT-LINE
                   ELSE
                       IF FIELD-LENGTH > 50
                           MOVE "Education degree cannot exceed 50 characters."
                               TO OUTPUT-LINE
                           PERFORM EMIT-LINE
                       ELSE
           ...
           GET-EDUCATION-UNIVERSITY.
               ...
               PERFORM UNTIL EDU-UNIVERSITY(EDUCATION-COUNT) NOT = SPACES
                   ...
                   MOVE FUNCTION LENGTH(FUNCTION TRIM(INPUT-VALUE))
                       TO FIELD-LENGTH
                   IF FIELD-LENGTH = 0
                       MOVE "Education university/college is required."
                           TO OUTPUT-LINE
                       PERFORM EMIT-LINE
                   ELSE
                       IF FIELD-LENGTH > 50
                           MOVE "Education university/college cannot exceed 50 characters."
                               TO OUTPUT-LINE
                           PERFORM EMIT-LINE
                       ELSE
                           MOVE FUNCTION TRIM(INPUT-VALUE)
           ...
           GET-EDUCATION-YEARS.
               ...
               PERFORM UNTIL EDU-YEARS(EDUCATION-COUNT) NOT = SPACES
                   ...
                   MOVE FUNCTION LENGTH(FUNCTION TRIM(INPUT-VALUE))
                       TO FIELD-LENGTH
                   IF FIELD-LENGTH = 0
                       MOVE "Years attended are required." TO OUTPUT-LINE
                       PERFORM EMIT-LINE
                   ELSE
                       IF FIELD-LENGTH > 20
       ...
       *> ============================================================
       ...
       CLEAR-EXPERIENCE-TABLE.
           PERFORM VARYING EXPERIENCE-INDEX FROM 1 BY 1
               ...
               MOVE SPACES TO EXP-TITLE(EXPERIENCE-INDEX)
               MOVE SPACES TO EXP-COMPANY(EXPERIENCE-INDEX)
               MOVE SPACES TO EXP-DATES(EXPERIENCE-INDEX)
               MOVE SPACES TO EXP-DESCRIPTION(EXPERIENCE-INDEX)
           END-PERFORM.

       CLEAR-EDUCATION-TABLE.
           PERFORM VARYING EDUCATION-INDEX FROM 1 BY 1
               UNTIL EDUCATION-INDEX > 3
               MOVE SPACES TO EDU-DEGREE(EDUCATION-INDEX)
               MOVE SPACES TO EDU-UNIVERSITY(EDUCATION-INDEX)
               MOVE SPACES TO EDU-YEARS(EDUCATION-INDEX)
           END-PERFORM.
               ...
               READ PROFILE-FILE
                   ...
                   NOT AT END
                       IF FILE-PROFILE-USERNAME = CURRENT-USERNAME
                           ...
                           MOVE "Y" TO PROFILE-FOUND PROFILE-EXISTS
                       END-IF
               END-READ
           END-PERFORM
       ...
       SAVE-PROFILE.
           ...
           MOVE PROFILE-RECORD TO NEW-PROFILE-RECORD
               ...
               READ PROFILE-FILE
                   ...
                   NOT AT END
                       IF FILE-PROFILE-USERNAME = CURRENT-USERNAME
                           ...
                           MOVE NEW-PROFILE-RECORD TO TEMP-PROFILE-RECORD
           ...
           CLOSE PROFILE-FILE TEMP-PROFILE-FILE
           ...
           PERFORM UNTIL TEMP-PROFILE-EOF = "Y"
           ...
           CLOSE TEMP-PROFILE-FILE PROFILE-FILE
           MOVE "Y" TO PROFILE-EXISTS
           MOVE "Profile saved successfully!" TO OUTPUT-LINE
           PERFORM EMIT-LINE.
       ...
       *> ============================================================
       ...
       VIEW-PROFILE.
           ...
           STRING
               ...
               FUNCTION TRIM(PROFILE-GRAD-YEAR) DELIMITED BY SIZE
               INTO OUTPUT-LINE
           END-STRING
           PERFORM EMIT-LINE
           ...
           STRING
               ...
               FUNCTION TRIM(PROFILE-ABOUT-ME) DELIMITED BY SIZE
               INTO OUTPUT-LINE
           END-STRING
           PERFORM EMIT-LINE
